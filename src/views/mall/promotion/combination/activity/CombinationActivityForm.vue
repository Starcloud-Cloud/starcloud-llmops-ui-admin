...
import * as CombinationActivityApi from '@/api/mall/promotion/combination/newCombinationActivity'
import { CombinationProductVO } from '@/api/mall/promotion/combination/newCombinationActivity'
...
import * as ProductSpuApi from '@/api/mall/product/newSpu'
