...
import * as SeckillActivityApi from '@/api/mall/promotion/seckill/newSeckillActivity'
import { SeckillProductVO } from '@/api/mall/promotion/seckill/newSeckillActivity'
