...
import * as BargainActivityApi from '@/api/mall/promotion/bargain/newBargainActivity'
// import { BargainProductVO } from '@/api/mall/promotion/bargain/bargainActivity'
import { BargainProductVO } from '@/api/mall/promotion/bargain/newBargainActivity'
