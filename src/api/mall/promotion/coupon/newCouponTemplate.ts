...
export function createCouponTemplate(data: CouponTemplateVO) {
  return request.post({
    url: '/llm/promotion/coupon-template/create',
    data: data
  })
}
...
export function updateCouponTemplate(data: CouponTemplateVO) {
  return request.put({
    url: '/llm/promotion/coupon-template/update',
    data: data
  })
}
...
export function updateCouponTemplateStatus(id: number, status: [0, 1]) {
  ...
  return request.put({
    url: '/llm/promotion/coupon-template/update-status',
    data: data
  })
}
...
export function deleteCouponTemplate(id: number) {
  return request.delete({
    url: '/llm/promotion/coupon-template/delete?id=' + id
  })
}
...
export function getCouponTemplate(id: number) {
  return request.get({
    url: '/llm/promotion/coupon-template/get?id=' + id
  })
}
...
export function getCouponTemplatePage(params: PageParam) {
  return request.get({
    url: '/llm/promotion/coupon-template/page',
    params: params
  })
}
...
export function getCouponTemplateList(ids: number[]) {
  return request.get({
    url: `/llm/promotion/coupon-template/list?ids=${ids}`
  })
}
...
export function exportCouponTemplateExcel(params: PageParam) {
  return request.get({
    url: '/llm/promotion/coupon-template/export-excel',
    params: params,
    responseType: 'blob'
  })
}
