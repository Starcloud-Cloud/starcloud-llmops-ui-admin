...
export const getBargainActivityPage = async (params: any) => {
  return await request.get({ url: '/llm/promotion/bargain-activity/page', params })
}

// 查询砍价活动详情
export const getBargainActivity = async (id: number) => {
  return await request.get({ url: '/llm/promotion/bargain-activity/get?id=' + id })
}

// 新增砍价活动
export const createBargainActivity = async (data: BargainActivityVO) => {
  return await request.post({ url: '/llm/promotion/bargain-activity/create', data })
}

// 修改砍价活动
export const updateBargainActivity = async (data: BargainActivityVO) => {
  return await request.put({ url: '/llm/promotion/bargain-activity/update', data })
}

// 关闭砍价活动
export const closeBargainActivity = async (id: number) => {
  return await request.put({ url: '/llm/promotion/bargain-activity/close?id=' + id })
}

// 删除砍价活动
export const deleteBargainActivity = async (id: number) => {
  return await request.delete({ url: '/llm/promotion/bargain-activity/delete?id=' + id })
}
